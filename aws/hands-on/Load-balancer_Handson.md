...
<body>
    <h1>This web server is launched from launch template by YOUR_NAME for chocolate e-commercial web-site</h1>
...
```
- Don't forget to select key-pair
...
- Select three instances that is created from Launch Template before and add to them to the target group.
...
- Show that three instances are added to the target group.
